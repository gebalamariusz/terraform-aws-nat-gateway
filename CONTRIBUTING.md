# Contributing to AWS NAT Gateway Terraform Module
...
Examples:
```
feat(nat): add support for private NAT gateway
fix(eip): correct tag propagation
...
- Prefix resources with module name: `aws_nat_gateway.this`
